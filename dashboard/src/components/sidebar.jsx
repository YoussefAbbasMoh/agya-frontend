...
import profileDefault from "../../public/User-60.png"
const Sidebar = () => {
        ...
        <img
          src={
            isAuthUser?.image === undefined
              ? isAuthUser?.user?.image === undefined ? profileDefault: 
              isAuthUser?.image === undefined ? profileDefault: isAuthUser?.image
              : profileDefault
        ...
        <div className="flex flex-col items-center space-y-6">
            ...
            <span className="w-12 inline-flex justify-end">
              <LayoutDashboard
                className={`w-5 h-5 duration-300 ${
                  location.pathname === "/dashboard/overview" ? "text-main" : ""
                }`}
              />
            </span>
            <span
          ...
          >
            <span className="w-12 inline-flex justify-end">
              <UsersRound
                className={`w-5 h-5 duration-300 ${
                  location.pathname === "/dashboard/users" ? "text-main" : ""
                }`}
              />
            </span>
            <span
            ...
            <span className="w-12 inline-flex justify-end">
              <MessageCircleWarning
                className={`w-5 h-5 duration-300 ${
                  ...
                  location.pathname === "/dashboard/report/post" ||
                  location.pathname === "/dashboard/report/comment"
                    ? "text-main"
                    : ""
                }`}
              />
          ...
          >
            <span className="w-12 inline-flex justify-end">
              <Tag
                className={`w-5 h-5 duration-300 ${
                  location.pathname === "/dashboard/tags" ? "text-main" : ""
                }`}
              />
            </span>
            <span
          ...
          >
            <span className="w-12 inline-flex justify-end">
              <Calendar
                className={`w-5 h-5 duration-300 ${
                  location.pathname === "/dashboard/activities" ? "text-main" : ""
                }`}
              />
            </span>
            <span
          ...
          >
            <span className="w-12 inline-flex justify-end">
              <Mail
                className={`w-5 h-5 duration-300 ${
                  location.pathname === "/dashboard/messages" ? "text-main" : ""
                }`}
              />
            </span>
            <span
          ...
          >
            <span className="w-12 inline-flex justify-end">
              <User
                className={`w-5 h-5 duration-300 ${
                  location.pathname === "/dashboard/admin" ? "text-main" : ""
                }`}
              />
            </span>
            <span
