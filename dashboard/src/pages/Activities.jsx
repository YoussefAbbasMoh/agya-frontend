...
export default function Activities() {
  ...
  useEffect(() => {
    try {
      fetch(
        `https://agyademo.uber.space/api/activities/${type}`,
        {}
      ).then((response) => {
        response.json().then((data) => {
        ...
        <div className=" w-full py-8">
          <div className=" mb-8 flex justify-between items-center">
            ...
            <button
              ...
              onClick={() => navigate("/dashboard/activities/pending-activities")}
            >
              Pending Activities
            </button>
          </div>
            ...
            activityData === undefined ? (
              ...
              activityData.map((activity) => {
                return (
                  <div
                    key={activity?._id}
                    onClick={() => navigate(`/dashboard/activities/${activity?._id}`)}
                  ...
                  >
                    <div className="relative">
                      <img
                        ...
                        alt="image"
                        className="w-[280px] bg-left object-cover min-h-[300px] max-h-[300px]"
                      />
                    </div>
