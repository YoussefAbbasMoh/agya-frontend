    ...
    <div className="p-4 sm:px-12 lg:px-24">
      ...
      <form className="article" onSubmit={(e) => e.preventDefault()}>
        <div className="mt-8">
          ...
          <h3 className="font-semibold my-2">Featured Image</h3>
          ...
          <div className="tags">
            ...
            <div className="flex h-[10px] items-center relative mb-[18px]">
              <CiSearch className="absolute top-[-9px] left-1 w-[25px]" />
              <input
                type="text"
                className="bg-white border border-main/50 w-full md:w-1/2 px-[40px] h-[30px] mb-[10px] rounded-[5px]"
                value={searchText}
            ...
            <div>
              <h3 className="font-semibold my-4">Article References</h3>
              <div className="flex flex-col w-full">
                <div className="w-full relative">
                  <input
                    type="text"
                    className="mb-5 h-[55px] bg-white rounded-lg border py-[2px] px-[5px] border-[#e6e6d7] w-full"
                    placeholder="Enter valid link (e.g., https://example.com)"
                    value={newReference}
                    onChange={(e) => setNewReference(e.target.value)}
                  />
                  <IoMdAdd
                    className="absolute right-2 bg-main text-white w-[40px] h-[40px] rounded-[5px] top-[8px] py-[2px] px-[8px] cursor-pointer"
                    onClick={() => {
            ...
            <div className="submit-article mt-3">
