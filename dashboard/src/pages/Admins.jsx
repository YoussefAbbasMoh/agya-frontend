      ...
      <div className="flex-1 ml-80 mx-[100px] py-8">
        ...
        <div>
          <div className=" my-8">
            ...
            {
              adminsData === undefined ?<div className=" block translate-x-[450px] my-4"><PropagateLoader color="#005F6A" size={20} /></div>: adminsData.length === 0 ? <div className=" block translate-x-[450px] my-4"><PropagateLoader color="#005F6A" size={20} /></div>: 
                <TableContainer>
              <Table
                sx={{ minWidth: 650 }}
              ...
              >
                ...
                <TableBody>
                  {adminsData === undefined ? (
                     <div className=" block translate-x-[450px] my-4"><PropagateLoader color="#005F6A" size={20} /></div>
                  ) : adminsData.length === 0 ? (
                    <div className=" block translate-x-[450px] my-4">No date</div>
                  ) : (
                        ...
                        <TableRow key={admin._id}>
                          <TableCell align="center" width={50}>
                            <span>
                              ...
                              <img
                                src={
                                  admin.image === "/uploads/default.png" || admin.image === undefined
                          ? "User-60.png"
                          : admin.image
                          ...
                          <TableCell width={50} align="center" className="">
                            <div className=" flex justify-center items-center rounded-xl border ">
                              <PencilOff
                                ...
                                onClick={() =>
                                  navigate(`/dashboard/admin/edit/${admin._id}`)
                                }
                              />
                              <Trash2
