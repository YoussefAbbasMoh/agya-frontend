      ...
      <div className="flex-1 ml-80 mx-[100px] py-8">
        ...
        <div className=" w-full  px-3 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {featuredArticlesData === undefined ? <div className=" block translate-x-[450px] my-16 h-52 w-52 "><PropagateLoader color="#005F6A" size={20} /></div>   :
            ...
            <div
              onClick={() => navigate("/dashboard/article/featured-articles")}
          ...
          <div className=" mt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {articlesData === undefined ? <div className=" block translate-x-[450px] my-16 h-52 w-52 "><PropagateLoader color="#005F6A" size={20} /></div>  
