          ...
          <div className=" flex justify-center items-center gap-6 mt-10">
            <div className=" bg-secondary text-main py-8 px-20 ">
              ...
              <p className=" text-center mt-2 text-xl text-black">
                {articlesCount === undefined ?  <div className=" block mx-auto my-5 h-2 w-2 "><PropagateLoader color="#005F6A" size={10} /></div>: articlesCount}
              </p>
            </div>
            <div className=" bg-secondary text-main py-8 px-20 ">
              <div className=" flex gap-3 items-center">
              ...
              <p className=" text-center mt-2 text-xl text-black">
                {repotrscount === undefined ? <div className=" block mx-auto my-5 h-2 w-2 "><PropagateLoader color="#005F6A" size={10} /></div> : repotrscount}
              </p>
            </div>
            <div className=" bg-secondary text-main py-8 px-20 ">
              <div className=" flex gap-3 items-center">
              ...
              <p className=" text-center mt-2 text-xl text-black">
                {usersCount === undefined ?<div className=" block mx-auto my-5 h-2 w-2 "><PropagateLoader color="#005F6A" size={10} /></div>  : usersCount}
              </p>
            </div>
          </div>
