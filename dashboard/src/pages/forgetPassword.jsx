...
export default function ForgetPassword() {
  ...
  const VerifyOTP = async (e) => {
    ...
    if (finalData.success) {
      ...
      setTimeout(() => {
        window.location.href = `/dashboard/edit-password/${finalData.admin._id}`;
      }, 500);
    } else {
      toastBC.current.show({
        severity: "error",
      ...
      <div className="flex justify-center items-center pt-52 pb-20 mx-4 md:mx-64 mt-[-100px]">
        <div className={`  duration-700 `}>
          <div className=" text-center  flex justify-center items-center">
            <img src="public\Logo.png" alt="" className=" w-52 h-20" />
          </div>
      ...
      {popup === true ? (
        ...
        >
          <div className="bg-white p-16 flex justify-center items-center flex-col rounded-xl mt-24">
            <div className=" text-center  flex justify-center items-center">
              <img src="public\Logo.png" alt="" className=" w-52 mb-4" />
            </div>
            <h3> Enter OTP </h3>
