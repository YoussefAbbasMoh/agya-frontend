    ...
    <div className="bg-white relative z-[100000] w-full max-w-md rounded-lg shadow-lg p-6 text-left">
      ...
      <div className="flex justify-center gap-4 mt-6">
        ...
        <button
          ...
          className="px-6 py-2 duration-300 text-sm font-medium text-white bg-main hover:bg-main/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-main/50"
        >
          Accept Cookies
        </button>
      </div>
