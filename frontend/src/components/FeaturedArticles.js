...
const FeaturedArticles = () => {
  ...
  const renderFallbackCard = () => (
    <div className="justify-center lg:ml-[-18px] items-center w-full px-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[55px]">
      <div className="lg:w-[180px] w-full max-w-md h-64 rounded-lg border border-main bg-SoftMain shadow flex flex-col items-center justify-center">
  ...
  return (
    <div className="w-full px-3 py-1 ">
      <h1 className="text-2xl text-left  ml-[-10px] text-black mb-8">Featured Articles</h1>
                  ...
                  <div className="group overflow-hidden rounded-lg border border-main bg-white shadow transition-transform hover:-translate-y-1 flex flex-col h-full">
                    <div className="overflow-hidden">
                      <img
                        ...
                        alt={article.title}
                        className="object-cover min-w-[500px] max-h-[200px] min-h-[200px] transition-transform duration-300 group-hover:scale-105"
                      />
                    </div> 
