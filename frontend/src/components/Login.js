    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      ...
      >
        ...
        <div className="w-full md:w-1/2 px-6 py-8 md:px-12 flex flex-col justify-center">
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="flex justify-end md:hidden mb-4">
              <div
                className="bg-main cursor-pointer text-secondary-font w-8 h-8 flex items-center justify-center rounded-full hover:bg-opacity-90"
                aria-label="Close"
        ...
        <div className=" relative">
          <div
            className="absolute hidden  cursor-pointer top-[-200px] right-4 text-secondary-font bg-main w-8 h-8 md:flex items-center justify-center rounded-full hover:bg-opacity-90 transition-opacity"
            aria-label="Close"
            onClick={() => setLoginPopup(false)}
          >
            <X size={18} />
