...
const Navbar = () => {
  ...
  return (
    <>
          ...
          >
            <div className="relative">
              ...
              <div
                ...
                className="absolute top-2 right-0 w-8 h-8 cursor-pointer flex items-center justify-center text-white bg-main rounded-full"
              >
                X
              </div>
              {/* Title */}
      ...
      {/* Navbar */}
      <header className={`w-full  py-3 mb-[-28px]`}>
        <div className="max-w-[1440px] mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex-1 max-w-xl mx-auto hidden md:flex items-center gap-2">
            ...
            >
              ...
              <input
                type="text"
                placeholder="Search articles by author, keyword"
                name="search"
          ...
          {/* Right Section */}
          <div className={`${location.pathname === "/" ? " lg:mr-[-35px]":""} flex items-center gap-2 relative`}>
            ...
            >
              ...
              <span className="lg:ml-2">New</span>
            </button>
            ...
            {activePopup === "dropdown" && (
              <div className="absolute top-14 right-8 pb-4 lg:right-0 w-48 bg-main text-white rounded-xl shadow-lg z-50">
        ...
        <div className="flex-1 max-w-xl mx-auto items-center gap-2 md:hidden">
          ...
          >
            ...
            <div className=" relative float-right z-100 translate-y-[-40px]">
              <button
              onClick={() => {
                mobileFilter === true
              ...
              className="p-3 md:hidden rounded-xl text-main hover:bg-opacity-90"
            >
              <ListFilter className="w-8 h-5" />
            </button>
            </div>
                  ...
                  <div className=" relative">
                                <div
                className={` absolute  left-[250px] gap-2 bg-white mt-6 z-[2000] p-4  rounded-xl  border w-72 `}
              >
                <h3 className="mb-2">Tags</h3>
