  ...
  return (
    <div>
      {loading ? (
        ...
        <div className=" max-w-[400px] md:max-w-xl w-screen rounded-3xl overflow-hidden bg-SoftMain border border-main/50">
          {/* Header */}
          ...
          >
            <div className="flex items-center flex-1">
              <div className="h-12 w-12 mr-3 rounded-full overflow-hidden">
                <img
                  src={item.authorId?.image === "/uploads/default.png"? "/User-60.png": item.authorId?.image}
                  alt="User avatar"
          ...
          <div onClick={onClick} className="cursor-pointer px-4 pt-0">
            <div
              className="content-container my-2"
