...
const ActivityCard = ({
  ...
  return (
    <div className="border rounded-lg overflow-hidden w-full cursor-pointer  flex flex-col lg:flex-row" onClick={() => navigate(`/activities/${_id}`)}>
...
const LatestActivityCard = ({
  ...
  return (
    <div
      className="border cursor-pointer rounded-lg overflow-hidden w-[300px] lg:w-[300px] lg:min-w-[300px] lg:max-w-[300px]  flex-shrink-0"
      onClick={() => navigate(`/activities/${_id}`)}
    >
...
const Activity = () => {
  ...
  return (
    <div className="lg:pr-65">
      <div className={`flex flex-col lg:flex-row relative ${activitiesData.length === 0 ? "":""} ${activitiesData.length <= 2 ? "":""}`}>
        <div className="flex flex-col w-full lg:w-3/4 px-4 lg:px-8">
          ...
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl my-[-8px] mb-[-18px]">Shared Activities</h3>
            {!filteredData || filteredData.length === 0 ? (
              <div className="text-center block translate-y-10  mx-auto mt-4">
          ...
          <div className={`relative ${activitiesData.length === 0 ? "":" " } ${activitiesData.length <= 2 ? "":"" }  mb-8`}>
            <div
          ...
          <h2 className="text-xl mb-4 mt-[-15px]">All Activities</h2>
          <div className={` ${ activitiesData.length === 0 ? "w-[450px] mr-[-220px]":""}`}>
          ...
          />
                     {!filteredData || filteredData.length === 0 ?               <div className="text-center block  mx-auto mt-4">
        ...
        <div className={`hidden lg:block ${activitiesData.length === 0 ? " translate-x-48":""} ${activitiesData.length < 2 ? " translate-x-44":""} ${activitiesData.length >= 2 ? " translate-x-40":""} w-fit`}>
