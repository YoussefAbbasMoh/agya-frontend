  ...
  return (
    <div className="flex flex-col max-h-fit  w-64 text-main-font rounded-lg border border-main/30 bg-SoftMain">
      ...
      <div className="flex flex-col items-center py-8">
        {/* Profile Image */}
        <img
          src={userInfo.image === "/uploads/default.png" ? "/User-60.png": userInfo.image} // Replace with the actual image URL
      ...
      <div className="mt-auto px-4 py-6 text-xs text-gray-400">
        <div className="w-3/4 mx-auto border-t border-gray-200">
          ...
          <p className="text-center pb-4">All Rights Reserved ©{year} Agya.com</p>
        </div>
      </div>
