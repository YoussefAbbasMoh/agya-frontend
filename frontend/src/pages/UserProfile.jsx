...
const UserProfile = () => {
  ...
  return (
    <div className={` ${activities.length === 0 || posts.length === 0 ? " translate-y-[-140px]": ""  } w-full max-w-7xl mx-auto p-4 sm:p-6 md:p-8`}>
      <div className="flex flex-col sm:flex-row items-center gap-4 mb-6">
        <div className="relative">
          <div className="w-36 h-36 rounded-full bg-gray-200 flex items-center justify-center">
            <img
              src={userInfo.image === "/uploads/default.png" ? "/User-60.png": userInfo.image}
      ...
      <div className="flex items-center justify-between mb-4">
        {!sortedActivities || sortedActivities.length === 0 ? (
          ...
          sortedActivities.length > 3 && (
            <div className="flex translate-x-96 gap-4">
              <button
